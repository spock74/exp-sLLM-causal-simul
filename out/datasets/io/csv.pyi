...
class CsvDatasetWriter:
    ...
    def __init__(self, dataset: Dataset, path_or_buf: PathLike | BinaryIO, batch_size: int | None = None, num_proc: int | None = None, storage_options: dict | None = None, **to_csv_kwargs) -> None: ...
    def write(self) -> int: ...
